...
# define SHADOW_ "/home/newton/unisgx/shadows/shadow"
...
int main(int argc, char *argv[]) {
	...
	if(ret != SGX_SUCCESS) {
		printf("ERRO %#08x na inicializacao do enclave ...\n\n", ret); 
	} else {
		...
		ret = ecall_seal_data(eid, &retval, SEALED_SHADOW ,file_data, file_length);
		if(ret != SGX_SUCCESS) {
			printf("ERRO ao selar os dados\n");
		} else {
